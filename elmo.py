...
from models import BiLSTMCRF, save_model, load_model, ELModel
...
class ELMOSequence(object):
    ...
    def fit(self, x_train, y_train, x_valid=None, y_valid=None,
        ...
        """
        #preprocessor elmo transformer
        #p = ELMoTransformer()
        #p.fit(x_train, y_train)
        p = ELMoTransformer()
        p.fit(x_train, y_train)
        EMBEDDING_PATH = "anago/data/glove.6B/glove.6B.100d.txt"
